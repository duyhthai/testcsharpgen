...
public class AuthControllerTests
{
    ...
    public async Task HandleRequest_WithNullRequest_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => controller.HandleRequest(null, mockMediator.Object));
    }
    ...
    public async Task HandleRequest_WithInvalidRequestType_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => controller.HandleRequest(new object(), mockMediator.Object));
    }
    ...
    public async Task HandleRequest_WithNonNullableRequestAndNullResult_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => controller.HandleRequest(new ForgotPasswordCommand(), mockMediator.Object));
    }
}